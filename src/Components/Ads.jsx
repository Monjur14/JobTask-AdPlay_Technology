...
const Ads = () => {
  ...
  return (
    <div className="w-full my-10 relative pb-4 overflow-hidden" onClick={() => setIsopen(!isOpen)}>
      <img src="/src/assets/Images/ap-logo.png" alt="" className="w-16 mx-auto"/>
      ...
      <div className="flex">
        ...
        <div className="basis-1/3 relative flex justify-center">
          <img src="/src/assets/Images/ap-product.png" alt="" className="w-28 mx-auto absolute -top-10 productAnimate"/>
        </div>
        <div className="basis-1/3">
      ...
      <div className={`w-full h-full bg-red-500 absolute ${isOpen ? "top-[0%]" : "top-[105%]"} transition-all duration-500 z-20`}>
        ...
        <img src="/src/assets/Images/ap-full-logo.png" alt="" className="absolute w-44 h-10 top-3 left-3"/>
      </div>
    </div>
  )
}
